...
Client.prototype.bindEventListeners = function() {
	...
	this.on("ch", function(msg) {
		/*if((msg.ch.crown && msg.ch.crown.userId && this.channel) && msg.ch.crown.userId != this.channel.crown.userId) {
			msg.ch.crown.oldUserId = this.channel.crown.userId;
			self.emit("crown", msg.ch.crown)
		}  */
